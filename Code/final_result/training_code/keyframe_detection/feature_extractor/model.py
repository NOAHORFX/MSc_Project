...
def eca_block(x, gamma=2, b=1):
    ...
    k = k if k % 2 == 1 else k + 1  # 确保为奇数

    y = GlobalAveragePooling2D()(x)
    y = Reshape((channels, 1))(y)
    y = Conv1D(1, kernel_size=k, padding='same', use_bias=False)(y)
...
def model(img_height, img_width, classes=3):
    ...
    base = Xception(input_tensor=inputs, weights='/home/featurize/data/xception_weights.h5', include_top=False)
...
# /home/featurize/data/xception_weights.h5
